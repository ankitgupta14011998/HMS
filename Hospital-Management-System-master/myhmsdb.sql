...
INSERT INTO `appointmenttb` (`pid`, `ID`, `fname`, `lname`, `gender`, `email`, `contact`, `doctor`, `docFees`, `appdate`, `apptime`, `userStatus`, `doctorStatus`, `apptmode`) VALUES
...
(1, 14, 'Ram', 'Kumar', 'Male', 'ram@gmail.com', '9876543210', 'Dinesh', 700, '2020-12-10', '00:00:00', 1, 1, ''),
(1, 15, 'Ram', 'Kumar', 'Male', 'ram@gmail.com', '9876543210', 'Amit', 1000, '2020-12-11', '00:00:00', 1, 1, ''),
(1, 16, 'Ram', 'Kumar', 'Male', 'ram@gmail.com', '9876543210', 'Kumar', 800, '2020-12-04', '12:00:00', 1, 1, 'Online');
...
--
-- Table structure for table `pathtb`
--
...
--
-- Dumping data for table `pathtb`
--

INSERT INTO `pathtb` (`username`, `password`, `email`, `spec`, `docFees`) VALUES
('amit', '12345', 'abc@mail.com', 'corona', 300);
...
(12, 'Amit ', 'kumar', 'Male', 'kamit2909@gmail.com', '9548066805', '123456', '123456');
...
('amit', 1, 15, 'Ram', 'Kumar', '2020-12-11', '00:00:00', 'covid positive', 'send to ward covid waks', 'mild symptoms');
