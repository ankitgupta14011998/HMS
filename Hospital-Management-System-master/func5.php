...
if(isset($_POST['docsub1'])){
	$dname=$_POST['username5'];
	$dpass=$_POST['password5'];
	$query="select * from pathtb where username='$dname' and password='$dpass';";
    ...
    while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
		...
		header("Location:path-panel.php");
	}
	else{
...
// {
// 	$name=$_POST['name'];
// 	$query="insert into pathtb(name)values('$name')";
// 	$result=mysqli_query($con,$query);
// 	if($result)
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab" aria-controls="messages">Test Result</a>
